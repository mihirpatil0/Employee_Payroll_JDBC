...
public class EmployeePayrollDBService
{
    ...
    {
        String sql = "SELECT gender, AVG(basic_pay) as average_salary FROM employee_payroll GROUP BY GENDER;";
    ...
    public EmployeePayrollData addEmployeeToPayroll(String employeeName, String Department,String gender, double BasicPay, LocalDate start)
    {
        ...
        String sql = String.format("INSERT INTO employee_payroll (name,department gender, basic_pay, start) " +
